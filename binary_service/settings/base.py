"""
Django settings for binary_service project.
...
ROOT_URLCONF = 'binary_service.urls'
...
WSGI_APPLICATION = 'binary_service.wsgi.application'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': (
        'binary_service.permissions.AllowOptionsAuthentication',
    )
}
