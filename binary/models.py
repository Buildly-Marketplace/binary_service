...
class Document(models.Model):
    ...
    file_description = models.CharField(max_length=50, help_text='File Description', null=True, blank=True)
    ...
    file = models.FileField(upload_to=partial(make_filepath, 'file'),null=True, blank=True,)
    thumbnail = models.FileField( upload_to=partial(make_filepath_thumbnail, 'file'), null=True, blank=True,)
    create_date = models.DateTimeField(null=True, blank=True)
    upload_date = models.DateTimeField(null=True, blank=True,auto_now_add=True)
    user_uuid = models.CharField(max_length=36, blank=True, null=True, verbose_name='User UUID')
